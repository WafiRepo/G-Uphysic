...
public class PhyphoxExperiment implements Serializable, ExperimentTimeReference.Listener {
    ...
    // Tambahkan metode untuk mendapatkan DataBuffer berdasarkan nama buffer
    public DataBuffer getDataBufferByName(String bufferName) {
        for (DataBuffer buffer : dataBuffers) {
            if (buffer.name.equals(bufferName)) {
                return buffer;
            }
        }
        return null; // Mengembalikan null jika buffer dengan nama tersebut tidak ditemukan
    }
