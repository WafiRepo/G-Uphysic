                ...
                Camera.PictureCallback pictureCallback = new Camera.PictureCallback() {
                    ...
                    public void onPictureTaken(byte[] data, Camera camera) {
                        ...
                        try {
                            ...
                            // Konversi ke Mat jika diperlukan

                            if (bitmap != null) {
                                // ROTASI hasil foto di sini agar tidak miring
                                int rotation = 90;
                            ...
                            // Panggil callback
                            if (callback != null) {
                                callback.onPictureTaken(rgbaMat);
                            }
                        } finally {
                            // Bersihkan resource
...
//                        mCamera.startPreview();
    ...
    private void setCameraDisplayOrientation() {
        ...
        if (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
            ...
            result = (360 - result) % 360;  // kompensasi mirror untuk kamera depan
        } else {  // kamera belakang
    ...
    // Tambahkan method ini di JavaCameraView
